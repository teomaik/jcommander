...
public class JCommander {
	...
	private void validateOptions() {
		...
		if (!requiredFields.isEmpty()) {
			...
			throw new ParameterException("The following "
					+ pluralize(requiredFields.size(), "option is required: ", "options are required: ") + message);
		}
	...
	private int methodRef3_ParseArgument(String arg, String a, int i, String[] args, boolean validate,
			Boolean isDashDash, Boolean commandParsed) { // 697-801
	...
	public static class Builder {
		 ...
		 * parse arguments into.
		 *
		 * @param o The arg object expected to contain {@link Parameter} annotations. If
		 *          <code>object</code> is an array or is {@link Iterable}, the child
		 *          objects will be added instead.
		 */
	 ...
	 * to previously added factories.
	 * 
	 * @param converterInstanceFactory the factory generating string converter
	 *                                 instances
	 */
